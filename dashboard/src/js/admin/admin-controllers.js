...
function SystemConfigurationController($scope, $http) {
    $scope.config = {
        workspace: {path: "kuona-workspace"},
        code: {
            collect: true,
            tool: {
                path: "",
    ...
    $scope.saveSystemConfiguration = function () {
        console.log("Configuration saving not yet implemented")
    }
}
...
adminModule
    ...
    .controller('SystemConfigurationController', ['$scope', '$http', SystemConfigurationController])
;
